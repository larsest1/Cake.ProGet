...
By contributing to Cake.ProGet, you assert that:

* The contribution is your own original work.
* You have the right to assign the copyright for the work (it is not owned by your employer, or
  you have been given copyright assignment in writing).
* You [license](https://github.com/apprenda/cake.proget/blob/develop/LICENSE) the contribution under the terms applied to the rest of the Cake.ProGet project.
* You agree to follow the [code of conduct](https://github.com/apprenda/cake.proget/blob/develop/CODEOFCONDUCT.md).
...
The `Cake.Proget` add-in exposes various functionalities exposed by the [Inedo ProGet](https://inedo.com/proget) product and should have no dependencies outside of the .NET framework and `Cake.Core`.
 ...
 * Create a GitHub issue to discuss a feature you would like to see (or a bug), and why it should be in cake.proget.
 ...
 * Alternatively, if a feature is on the issues list with the
   [Up For Grabs](https://github.com/apprenda/cake.proget/labels) label,
 ...
 * You create, or update, a fork of apprenda/cake.proget under your GitHub account.
 ...
 * Once you feel it is ready, submit the pull request to the `apprenda/cake.proget` repository against the `develop` branch
 ...
 * `git fetch upstream` (upstream would be the mainstream repo or `apprenda/cake.proget` in this case)
